...
def send_start(bot, update):
    ...
    keyboard += [[InlineKeyboardButton(text="Join Support Group👥", url="t.me/groupzoidsupport") 
        InlineKeyboardButton(text="📣Join Updates Channel 📣", url="t.me/igroupzoid")]]
    keyboard = [[InlineKeyboardButton(text="🤖Support Bot🤖", url="t.me/groupzoidsupportbot")]]
