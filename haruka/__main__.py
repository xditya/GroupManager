...
PM_START_TEXT = """
Hey there *{}*! My name is Chika Fujiwara. i'm a group manager bot.You can find my list of available commands with /help.
It's a waste not to try something that seems fun. Maintained by my side @chikasupport"""

HELP_STRINGS = """
Hey there! My Name is *{}*!
I am an Anime themed group management bot.
To add me to your group click ["HERE"](t.me/Chika_FujiwaraRobot?startgroup=botstart)
You can find my list of available commands with /help.
[Chika's Repo](github.com/JayPatel1314/Tanjiroold) 
See [Basic Configuration Checklist](t.me/OnePunchUpdates/29) on how to secure your group.
If any Questions Regarding Chika Then Join [Chika Support](https://t.me/chikasupport).
...
SAITAMA_IMG = "https://telegra.ph/file/67c0ebd373de0a102b16f.jpg"
        ...
        if len(args) >= 1:
            ...
            update.effective_message.reply_photo(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [[
                        InlineKeyboardButton(
                            text="📍Add Chika Fujiwara to your group!📍",
                     ...
                     [
                         InlineKeyboardButton(
                             text="📸 Source Code.",
                             url="https://github.com/JayPatel1314/Tanjiroold")
                     ]]))
    else:
